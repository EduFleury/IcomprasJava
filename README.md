...
Este projeto demonstra uma arquitetura de microserviços orientada a eventos (Event-Driven Architecture - EDA) para um sistema de e-commerce, utilizando **Spring Boot** para o desenvolvimento dos serviços e **Apache Kafka** como o *message broker* central para a comunicação assíncrona.
...
| **Faturamento** | Spring Boot, Kafka | Serviço que processa o faturamento do pedido após a confirmação de pagamento. |
...
A imagem a seguir ilustra o fluxo de eventos e a interação entre os microserviços:

![Arquitetura](https://github.com/user-attachments/assets/84be92c7-ea33-40a4-965c-e3de7925ac4b)
