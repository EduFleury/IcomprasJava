package io.github.eduardopina.icompras.logistica.service;
...
import io.github.eduardopina.icompras.logistica.publisher.EnvioPedidoPublisher;
...
public class EnvioPedidoService {
    ...
    private String gerarCodigoRastreio(){
        ...
        int numeros = 10000000 + random.nextInt(90000000);
